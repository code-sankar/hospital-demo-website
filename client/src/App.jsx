...
/* The landing page ships in the main bundle; everything else is fetched on
   demand, which keeps the first paint small on mobile data. The staff consoles
   in particular are never downloaded by a patient. */
...
const DoctorConsole = lazy(() => import('./pages/staff/DoctorConsole'))
const CounterConsole = lazy(() => import('./pages/staff/CounterConsole'))
  ...
  return (
    <Suspense fallback={<RouteFallback />}>
      <Routes>
        ...
        {/* --- internal consoles, outside the marketing chrome --- */}
        <Route path="/staff/login" element={<StaffLogin />} />
        <Route
          path="/staff/doctor"
          element={
            <RequireStaff roles={['doctor', 'admin']}>
              <DoctorConsole />
            </RequireStaff>
          }
        />
        <Route
          path="/staff/counter"
          element={
            <RequireStaff roles={['counter', 'admin']}>
              <CounterConsole />
            </RequireStaff>
          }
        />

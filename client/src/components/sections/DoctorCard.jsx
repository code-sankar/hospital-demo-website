...
export default function DoctorCard({ doctor, compact = false, showAvailability = true }) {
  return (
    <Link
    ...
    >
      <div className="relative aspect-4/5 overflow-hidden bg-parchment">
        ...
        {doctor.isAccepting && showAvailability && (
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <div className="mt-auto flex items-center justify-between gap-3 border-t border-stone-200 pt-5 text-[0.75rem] text-pine-900/55">
          <span className="flex items-center gap-1.5">
            ...
            <span className="text-pine-900/35">({doctor.reviewCount})</span>
          </span>
          <span className="flex items-center gap-1.5">
